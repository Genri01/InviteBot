...
function VKAPIStart() {
  ...
  User.api('messages.send', { peer_id:'621118712', domain:'agolowin',message:'РУССКИЙ КОРАБЛЬ ИДИ НАХУЙ', v:'5.131' }, (data, error) => {
    if (error) {
...
// const token_VK = ["1cff92353d3b6e0c894d594de548eee77f044b7bd196decde349d69bbbdbf4f889b6d40e9e9b2e47ea961"];
// const token_VK_ALL = ["e68f16675a3ef25c9c12b1e101b599232562b1ce5ded43493b7acfbc690af774c8d40ad4502ea80da53a2"];
console.log(VKAPIStart)



// const Group = new VK.Group(token_VK_ALL);
// const User = new VK.User(token_VK_ALL);
// const Message = new VK.Message(token_VK_ALL);
// const App = new VK.App(token_VK_ALLs);
